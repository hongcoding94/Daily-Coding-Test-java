...
#### 8. 이진 탐색 트리
  ...
  - 이진 탐색 트리의 연산
    ...
    3. 검색
        - 타겟 데이터가 존재하는 여부
        >  - 찾고자 하는 값과 현재 루트 노드의 값 비교
        >  &nbsp; &nbsp; &nbsp; ▶ 타겟 값이 더 크다면 오른쪽 서브 트리로 이동
        >  &nbsp; &nbsp; &nbsp; ▶ 타겟 값이 더 작다면 왼쪽 서브 트리로 이동
...
#### 11. 참고내용
 ...
 20. [makemethink님의 ](https://makemethink.tistory.com/134)
 21. [yooil605님의 알고리즘 시리즈](https://velog.io/@yooil605/series/Algorithms-Data-Structure)
