...
#### 8. 이진 탐색 트리
  ...
  - 이진 탐색 트리의 연산
   ...
   ※ 만약 이해가 되지 않는다면 해당 링크를 참고하기 바랍니다. → [이진 탐색 트리의 연산](https://makemethink.tistory.com/134)
...
#### 11. 참고내용
 ...
 22. []()
 23. [yooil605님의 알고리즘 시리즈](https://velog.io/@yooil605/series/Algorithms-Data-Structure)
