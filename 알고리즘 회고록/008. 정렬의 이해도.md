...
10. [참고자료](https://github.com/hongcoding94/Daily-Coding-Test-java/blob/main/%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98%20%ED%9A%8C%EA%B3%A0%EB%A1%9D/008.%20%EC%A0%95%EB%A0%AC%EC%9D%98%20%EC%9D%B4%ED%95%B4%EB%8F%84.md#10-%EC%B0%B8%EA%B3%A0%EC%9E%90%EB%A3%8C)
...
- 선택 정렬의 특징
  - 자료 이동 횟수가 미리 결정된다.<br/>
  - 데이터 양이 적을 때 성능이 향상 (장점이자 단점)

- 선택 정렬의 주의점
  - 값이 동일한 경우 상대적인 위치가 변경됨<br/>
...
- java 코드의 구현
  ...
  public class Selection_sort() {
    public static void main(String[] args) {
      ...
      System.out.printlnt(selection.sort(data));
    }
...
### 4. 삽입 정렬
<div align="center">
   <img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbODi6H%2FbtrlfRa7nBL%2F7O0qrBn0meNPWulyWbDQtK%2Fimg.gif" width="500" height="" /> 
</div>
...
<div align="center">
  ...
  |사간복잡도|최악 시간복잡도|최선 시간복잡도|평균 시간복잡도|공간복잡도|
  |---|:---:|:---:|:---:|:---:|
  |내용|О(n2) 비교 및 교환|O(n) 비교, O(1) 교환|О(n2) 비교 및 교환|	О(n) 전체, O(1) 보조|
</div>
